    ...
    render() {
        ...
        return (
            <div className="row">
                ...
                <div className="col-9">
                    <div className="row">
                        <div className="col-12 mb-5 company-advertisement-name">{/*Company*/ this.props.getCompanyAdvertisement.title}</div>
