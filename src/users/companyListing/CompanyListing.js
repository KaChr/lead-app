    ...
    render() {
        return (
            <div className="row mt-5 mb-3 border border-secondary company-listing-main">
                <div className="col-3 company-listing-padding"><a href="http://placeholder.com"><img src="http://via.placeholder.com/50x50" alt="test" /></a></div>
                <div className="col-3 company-listing-padding">
                    <div className="row">
                ...
                <div className="col-3 company-listing-padding company-listing-city"><i className="fa fa-map-marker-alt company-listing-icon"></i>&nbsp;Stockholm</div>
                <div className="col-3 company-listing-padding company-listing-intern-positions">
                    <div className="row">
